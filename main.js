...
function updateSensorReadings(data) {
  ...
  document.getElementById("pms1_0").innerText = data.PMS5003.PMS1_0";
  document.getElementById("pms2_5").innerText = data.PMS5003.PMS2_5";
  document.getElementById("pms10").innerText = data.PMS5003.PMS10";
